    ...
    for key, mask in masks.items():
        ...
        for i, rectangle in enumerate(rectangles):
            ...
            if M["m00"] != 0:
                ...
                # quadrant logic
                height, width = image.shape[:2] # getting video dimensions              
                highQuadrantBoundary = height/1.6
                # lowQuadrantBoundary = (height/3) * 2.25
                ''' testing values
                print(highQuadrantBoundary) # 213
                print(lowQuadrantBoundary) # 426
                '''
                if cY < highQuadrantBoundary:
                    llpython[3] = 1 # top quadrant
                else:
                    llpython[3] = 2 # low quadrant     
                '''
                elif cY < lowQuadrantBoundary:
                    llpython[3] = 2 # middle quadrant
                '''
                print(llpython[3])
